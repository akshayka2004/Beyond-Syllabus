...
export default function ChatHome() {
  ...
  return (
    <div className="paper-texture flex flex-col h-screen md:h-[calc(100vh-1rem)] md:m-3 md:rounded-3xl border border-border">

      {!isInitial && (
        <div className="sticky top-0 z-50 bg-[hsl(var(--paper)/0.8)] backdrop-blur-md">
          <Header />
        </div>
      )}
